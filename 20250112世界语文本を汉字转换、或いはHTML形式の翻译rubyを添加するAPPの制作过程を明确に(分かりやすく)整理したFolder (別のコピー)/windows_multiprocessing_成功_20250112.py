...
with open('./例句_Esperanto文本.txt','r', encoding='utf-8') as g:
    ll=g.read()
text2=replace_esperanto_chars(ll,x_to_circumflex)
text2=replace_esperanto_chars(ll,hat_to_circumflex)
...
if __name__ == '__main__':
    ...
    text3=parallel_process(text2*text_repeat_times, num_processes,replacements_final_list_2, imported_data_replacements_list_for_2char)
    ...
    rt.ruby-L_L_L {
    top: -0.50em; /* 大きめの文字は少し上げる */
    }
    rt.ruby-XL_L_L {
    top: -0.65em; /* 大きめの文字は少し上げる */
    }
    rt.ruby-XXL_L_L {
    top: -0.80em; /* 大きめの文字は少し上げる */
    }
    ...
    with open('./Esperanto文本_转换结果_windows_多重处理.html','w', encoding='utf-8') as h:
        h.write(text4)