...
if uploaded_file is not None:
    ...
    with open("./files_needed_to_get_replacements_text/tmp.txt", 'r', encoding='utf-8') as file:
        # "tmp.txt"の各行をループ。
        for line in file:
            # ':'が出てくるまでの部分を取り出す。
            word = line.split(":")[0]
    ...
    with open("./files_needed_to_get_replacements_text/检查世界语所有单词的结尾是否被正确切除(result).txt","w",encoding='utf-8') as g:
        for hh in result:
    ...
    with open("./files_needed_to_get_replacements_text/replacements_list.txt", 'w', encoding='utf-8') as file:
    ...
    # QQ
    with open("./files_needed_to_get_replacements_text/QQ.txt", 'w', encoding='utf-8') as file:
    ...
    with open("./files_needed_to_get_replacements_text/RR.txt", 'w', encoding='utf-8') as file:
    ...
    with open("./files_needed_to_get_replacements_text/pre_replacements3.txt", 'w', encoding='utf-8') as file:
