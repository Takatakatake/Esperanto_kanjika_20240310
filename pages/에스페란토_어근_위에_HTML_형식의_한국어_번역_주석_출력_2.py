...
import re
# JSONファイルを読み込む
with open("./files_needed_to_get_replacements_list_json_format/ABC_replacements_list_for_2char_Korean_2.json", "r", encoding="utf-8") as f:
...
replacements3 = []
with open("./files_needed_to_get_replacements_list_json_format/最終的な置換用のリスト(replacements_final_list)_Korean2.json", 'r', encoding='utf-8') as g:
