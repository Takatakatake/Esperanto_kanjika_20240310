...
# サンプルファイルのパス
file_path4 = './files_needed_to_get_replacements_text/replacements_list_ruby_html_format_中文_対応ruby尺寸更改.txt'
# ファイルを読み込む
...
# サンプルファイルのパス
file_path5 = './files_needed_to_get_replacements_text/replacements_list_ruby_html_format_日本語_ルビサイズ変更対応.txt'
# ファイルを読み込む
